...
dst = Button(root, text="Prediction 1", command=DecisionTree,bg="light grey",fg="orange")
...
lr = Button(root, text="Prediction 3", command=NaiveBayes,bg="light grey",fg="black")
